function AppDataModel() {
    var self = this,
        ...
        saveBasketballGameUrl = "/api/Game/saveBasketballGame",
    ...
    function basketballGameUrl(sport) {
        return "/api/Game/BasketballGame?sport=" + (encodeURIComponent(sport));
    }
    ...
    self.saveBasketballGame = function (data) {
        return $.ajax(saveBasketballGameUrl, {
            type: "POST",
            data: data,
            headers: getSecurityHeaders()
        });
